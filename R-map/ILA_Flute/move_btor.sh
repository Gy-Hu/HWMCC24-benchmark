...
base_dir="/data/guangyuh/coding_env/HWMCC24-benchmark/R-map/ILA_Flute/verification"
target_dir="/data/guangyuh/coding_env/HWMCC24-benchmark/btor2_only/bv"
...
find "$base_dir" -name "*.btor2" | while read -r file; do
  ...
  new_file_name="ILA_Flute_${dir_name}_${file_name}"
