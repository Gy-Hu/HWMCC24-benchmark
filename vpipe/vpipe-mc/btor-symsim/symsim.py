...
def main():
  ...
  sts, _ = btor_parser.parse_file(Path("/data/wenjifang/vpipe-mc/btor-bmc/example/pipe-no-stall.btor2"))
  executor = SymbolicExecutor(sts)

  print(sts.input_var)
  print(sts.assumption.serialize())
  print(sts.init)
  print(get_free_variables(sts.init))
  exit()
