...
def ila_trans():
    ...
    sts, _ = btor_parser.parse_file(Path("/data/wenjifang/SymSim-Framework/design/testcase2-three_stage_pipe/problem_set.btor2"))
...
def main(extracted_list, sv_extracted_list):
    file_name = "/data/wenjifang/SymSim-Framework/output/branch_list_c2_set.pkl"
