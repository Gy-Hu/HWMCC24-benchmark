...
def main():
    file_name = "/data/wenjifang/vpipe-mc/btor-symsim/branch_list.pkl"
    open_file = open(file_name,"rb")
    branch_list = pickle.load(open_file)


    btor_parser = BTOR2Parser()
    sts, _ = btor_parser.parse_file(Path("/data/wenjifang/vpipe-mc/btor-symsim/pipe-with-stall.btor2"))
