...
def symtraverse_all_step():
  ...
  sts, _ = btor_parser.parse_file(Path("/data/wenjifang/vpipe-mc/simple-test-case/arb-start-stall/test.btor2"))
  ...
  for idx0_0 in range(len(s0_0)):
      ...
      traverser0_1.traverse_one_step(assumptions=tag2asmpt('tag1'), branching_point=order)
  ...
  # for idx in range(len(s1_1)):
    ...
    traverser1_2.traverse_one_step(assumptions=tag2asmpt('tag2'), branching_point=order)
  ...
  # for idx in range(len(s2_2)):
    ...
    traverser2_3.traverse_one_step(assumptions=tag2asmpt('tag3'), branching_point=order)
