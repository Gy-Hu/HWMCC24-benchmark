...
def symtraverse_all_step():
  ...
  sts, _ = btor_parser.parse_file(Path("/data/wenjifang/vpipe-mc/ILA-pipeline/ilang_simple_pipe/stall_vrecorder/verify/ADD/problem2.btor2"))
  ...
  file_name = "branch_list_c4_0614.pkl"
