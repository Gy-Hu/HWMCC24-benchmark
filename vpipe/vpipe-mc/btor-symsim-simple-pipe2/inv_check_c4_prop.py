...
def main(extracted_list, sv_extracted_list):
    file_name = "/data/wenjifang/vpipe-mc/btor-symsim-simple-pipe2/branch_list_c4.pkl"
    ...
    all_pairs,_ = extract_pair_of_regval_from_branch_list(branch_list, 6, 7)
    ...
    asmpt_init_check = Implies(tag_start, EqualsOrIff(v0, BV(1,1)))
    init_check_generic_func(inv_ila_rtl, sts_init_extended, asmpt_init_check)
