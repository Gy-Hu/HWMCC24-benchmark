...
def symtraverse_all_step():
  ...
  sts, _ = btor_parser.parse_file(Path("/data/wenjifang/SymSim-Framework/design/testcase3-four_stage_pipe1/problem_nop.btor2"))
  ...
  file_name = "/data/wenjifang/SymSim-Framework/output/branch_list_c3_nop.pkl"
  open_file = open(file_name,"wb")
  pickle.dump(branch_list,open_file)
  open_file.close()
